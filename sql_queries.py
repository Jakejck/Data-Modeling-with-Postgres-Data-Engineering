...
songplay_table_create = ("CREATE TABLE IF NOT EXISTS songplays (songplay_id int,start_time time, user_id int,\
level varchar,song_id int,artisit_id int,session_id int,\
