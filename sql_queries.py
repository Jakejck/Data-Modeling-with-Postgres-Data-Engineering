...
songplay_table_create = ("CREATE TABLE IF NOT EXISTS songplays (songplay_id int,start_time numeric, user_id varchar,\
...
time_table_create = ("CREATE TABLE IF NOT EXISTS time (start_time numeric,hour varchar,day varchar ,week varchar,\
